...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'TankTest10M.data';
    var REMOTE_PACKAGE_BASE = 'TankTest10M.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 8281321;
      var PACKAGE_UUID = '28e4d243-19a5-49ed-bc07-cd78ca2e0fe7';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 4931057, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(4931057, 4931203, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(4931203, 6757003, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(6757003, 8253695, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(8253695, 8281321, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_TankTest10M.data');

    };
    Module['addRunDependency']('datafile_TankTest10M.data');
